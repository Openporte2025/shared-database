 ...
 * - Supporto Odoo Integration (odoo_id)
 * 
 * @version 1.2.0
...
window.closePMProjectModal = function() {
    ...
    // Pulisci variabili Odoo quando si chiude il modal
...
window.createPMProject = async function() {
    ...
    // ═══════════════════════════════════════════════════════════════
    // ODOO INTEGRATION - Recupera odoo_id se presente
    // ═══════════════════════════════════════════════════════════════
    const odooId = window._pendingOdooId || null;
    const odooCustomer = window._pendingOdooCustomer || null;
    
    if (odooId) {
        console.log(`🔗 Progetto collegato a Odoo ID: ${odooId}`);
    }
    ...
    const project = {
        ...
        // ═══════════════════════════════════════════════════════════════
        // ODOO INTEGRATION - Salva odoo_id nel progetto
        // ═══════════════════════════════════════════════════════════════
        odoo_id: odooId,
        ...
        metadata: {
            ...
            device: 'Dashboard',
            syncStatus: 'synced',
            // Salva anche qui per retrocompatibilità
            odoo_id: odooId
        },
        changeLog: [{
            timestamp: now,
            device: 'Dashboard',
            action: odooId ? `Creato da Odoo (ID: ${odooId})` : 'Creato nuovo progetto'
        }]
    };
    ...
    try {
        ...
        alert(`✅ Progetto "${name}" creato! (ID: ${projectId})${odooId ? '\n🔗 Collegato a Odoo' : ''}`);
...
console.log(`📦 PM Dashboard Integration v${PM_INTEGRATION_VERSION} caricato (con supporto Odoo)`);
