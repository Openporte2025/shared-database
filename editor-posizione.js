...
// v1.4.0: SEMPLIFICATO - Ricarica pagina dopo salvataggio (come app rilievo)
// ============================================================================
...
async function editorSave() {
    ...
    try {
        ...
        if (syncSuccess) {
            showEditorToast('✅ Salvato! Ricarico...');
            console.log(`✅ Posizione ${posId} sincronizzata su GitHub`);
            
            // 🔧 v1.4.0: METODO SEMPLICE - Ricarica la pagina dopo salvataggio
            // Come fa l'app rilievo: salva e poi aggiorna tutto
            setTimeout(() => {
                location.reload();
            }, 1000);
