...
(function() {
    ...
    function openNewProjectModal() {
        ...
        // Metodo 3: Cerca bottoni con testo "Nuovo"
        const allButtons = document.querySelectorAll('a, button, .btn, [role="button"]');
        for (const btn of allButtons) {
            if (btn.textContent && btn.textContent.toLowerCase().includes('nuovo progetto')) {
                btn.click();
                console.log('   ✅ Click su bottone con testo "Nuovo Progetto"');
                return true;
            }
        }
        
        // Metodo 4: Mostra modal direttamente
        const modals = ['#pm-modal', '#pm-project-modal', '#projectModal', '.project-modal'];
